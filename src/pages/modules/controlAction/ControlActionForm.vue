    ...
    >
      ...
      <template #1-content>
        <ControlDetailsActionsForm
          ...
          :isControlActionTemplateModule="false"
...
import ControlDetailsActionsForm from './components/ControlDetailsActionsForm.vue'
import CritriaListComponent from './components/CritriaListComponent.vue'
...
import { getExecutionType } from './widgets/controlsUtil'
export default {
  data() {
    return {
      basicDetails: {
      ...
      formObj: {
        ...
        headerObject: {
          title: this.$t('controls.new_ca', { ns: 'energy' }),
          description: this.$t('controls.ca_description', { ns: 'energy' }),
          gradient: 'blue',
        },
        isForm: true,
      },
  ...
  computed: {
    isNotAllowSave() {
      ...
      let revertNotConfigured = isEnableRevert && isEmpty(revertActionDateTime)
      return (
        isEmpty(name) ||
