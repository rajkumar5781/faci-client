<template>
  <FContainer class="w-full h-full">
    <NewLineItemList
      v-bind="$attrs"
      ref="lineItemTable"
...
import NewLineItemList from './NewAssociateResource.vue'
import getProperty from 'dlv'

export default {
  props: ['widget', 'details', 'resizeWidget', 'fitMyContent'],
  components: {
    NewLineItemList,
    FContainer,
  },
  ...
  computed: {
    ...
    moduleId() {
      return getProperty(this.widget, 'widgetParams.module.moduleId', null)
    },
    recordId() {
