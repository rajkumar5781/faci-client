        ...
        >
          ...
          >
            <FContainer v-if="days < 2">
              {{ $t('workorder.day', 'DAY', { ns: 'workorder' }) }}
            </FContainer>
            <FContainer v-else>
              {{ $t('workorder.days', 'DAYS', { ns: 'workorder' }) }}
            </FContainer>
          </FText>
        </FContainer>
      </FContainer>
        ...
        >
          ...
          >
            <FContainer v-if="hours < 2">
              {{ $t('workorder.hour', 'HR', { ns: 'workorder' }) }}
            </FContainer>
            <FContainer v-else>
              {{ $t('workorder.hours', 'HRS', { ns: 'workorder' }) }}
            </FContainer>
          </FText>
        </FContainer>
      </FContainer>
        ...
        >
          ...
          >
            <FContainer v-if="mins < 2">
              {{ $t('workorder.min', 'MIN', { ns: 'workorder' }) }}
            </FContainer>
            <FContainer v-else>
              {{ $t('workorder.mins', 'MINS', { ns: 'workorder' }) }}
            </FContainer>
          </FText>
        </FContainer>
      </FContainer>
        ...
        >
          ...
          >
            <FContainer v-if="secs < 2">
              {{ $t('workorder.sec', 'SEC', { ns: 'workorder' }) }}
            </FContainer>
            <FContainer v-else>
              {{ $t('workorder.secs', 'SECS', { ns: 'workorder' }) }}
            </FContainer>
          </FText>
        </FContainer>
      </FContainer>
