...
export const initDataDog = (account, instance) => {
  ...
  let disabledDataDog = getProperty(account, 'data.orgInfo.disableDataDog')
  if (
    !isEmpty(dataDogClientId) &&
    !email.includes('@facilio.com') &&
    !disabledDataDog
  ) {
